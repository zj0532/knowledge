                    ...
                    if (_a7 == "next") {
                        ...
                        if (_a7 == "last") {
                            ...
                            if (_a7 == "manual") {
                                ...
                                $("<td style=\"padding-left:5px;\"></td>").html(_a3.beforePageText).appendTo(tr);
                                ...
                                bb.after = $("<td style=\"padding-right:5px;\"></td>").appendTo(tr);
                            } else {
                                if (_a7 == "refresh") {
...
if (_a3.buttons) {
    // 原始的分页自定义按钮，修改为右侧对齐
    // _a4 是 datagrid-pager
    //$("<td><div class=\"pagination-btn-separator\"></div></td>").appendTo(tr);
    var pagerButtonsTable = $("<table cellspacing=\"0\" cellpadding=\"0\" border=\"0\" style=\"position:absolute;top:0px;right:10px\"><tr></tr></table>");
    var pagerButtonsTableTr = $(pagerButtonsTable).find("tr");
    if ($.isArray(_a3.buttons)) {
        for (var i = 0; i < _a3.buttons.length; i++) {
            var btn = _a3.buttons[i];
            if (btn == "-") {
                $("<td><div class=\"pagination-btn-separator\"></div></td>").appendTo(pagerButtonsTableTr);
            } else {
                var td = $("<td></td>").appendTo(pagerButtonsTableTr);
        ...
        //console.info(_a3.buttons);
    }
    $(pagerButtonsTable).appendTo(_a4);
}
...
bb.num.val(_b5.pageNumber);
    ...
    // 显示分页信息
if (bb.after) {
    //console.info(_b5.afterPageText);
    bb.after.html(_b5.afterPageText.replace(/{pages}/, _b6) + "， 共" + _b5.total + "条");
}
...
if(opts.pagination){
var _5b8 = $("<div class=\"datagrid-pager\" style=\"position:relative;\"></div>");
