<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MyKnowLedge.aspx.cs" Inherits="Pactera.Knowledge.MyKnowLedge" %>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $("#KnowLedgeList").datagrid({
                ...
                queryParams: { action: "getMyKnowlist" },
                method: "post",
                height: 520,
                singleSelect: true,
                pagination: true,
            ...
            $("#knowledgeAdd").linkbutton({
                ...
                onClick: function () {
                    ...
                    parent.createAndOpenModalWindow("添加知识点", 800, 460, url, function (data) {
                        if (data != null && data == 1) {
                            btnSearch();
                        }
                    });
        ...
        function btnSearch() {
            ...
            $("#KnowLedgeList").datagrid("load", { action: "getMyKnowlist", OneValue: OneValue, TwoValue: TwoValue, ThreeValue: ThreeValue, FourValue: FourValue, MalDescription: MalDescription, Created: Created, CreateDateStart: CreateDateStart, CreateDateEnd: CreateDateEnd });
