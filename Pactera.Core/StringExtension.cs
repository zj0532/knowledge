...
namespace Pactera.Core
{
    ...
    public static class StringExtensions
    {
        ...
        {
            Guard.IsNullOrEmpty(input, "input");
        ...
        {
            Guard.IsNullOrEmpty(src, "scr");
            Guard.IsNullOrEmpty(prefix, "prefix");
        ...
        {
            Guard.IsNullOrEmpty(src, "scr");
            Guard.IsNullOrEmpty(value, "value");
        ...
        {
            Guard.IsNullOrEmpty(src, "scr");
            Guard.IsNullOrEmpty(start, "start");
            Guard.IsNullOrEmpty(end, "end");
